...
- Any durable insights have been captured as vault learning-record-style entries, **or**
...
- Give a clear done signal: "produce synthesis note + learning record in vault".
