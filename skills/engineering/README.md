...
- **[ask-brain](./ask-brain/SKILL.md)** — Ask which skill or flow fits your situation. A router over the user-invoked skills in this repo.
...
- **[agent-loop](./agent-loop/SKILL.md)** — Plan → Act → Observe → Verify → Stop discipline for autonomous iteration until verifiers pass or stop rules fire.
